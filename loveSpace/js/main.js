...
window.addEventListener('load', function () {
    ...
    setTimeout(function () {
        iziToast.show({
            ...
            icon: false,
            title: hello,
            message: 'Welcome to our lovespace'
        });
    }, 800);
...
setTimeout(function () {
    $('#loading-text').html("This may spend a little time")
}, 5000);
...
$('#upWeather').click(function () {
    if (wea == 0) {
        ...
        iziToast.show({
            ...
            message: 'real time has been updated'
        });
    } else {
        iziToast.show({
            timeout: 1000,
...
for (let day of days) {
    ...
    if (mon == d[0] && date == d[1]) {
        ...
        $("#change1").html("Today is China's National Memorial Day, the whole station has switched to black and white mode");
        window.addEventListener('load', function () {
            setTimeout(function () {
                iziToast.show({
                    timeout: 14000,
                    icon: "fa-solid fa-clock",
                    message: "Today is China's National Memorial Day"
                });
            }, 3800);
        }, false);
    }
...
$('#switchmore').on('click', function () {
    ...
    if (shoemore && $(document).width() >= 990) {
        ...
        $("#change").html("Oops&nbsp;!");
        $("#change1").html("How could you find this!(One more click to close)");
    } else {
        $('#container').attr('class', 'container');
        $("#change").html("Welcome&nbsp;to&nbsp;Our&nbsp;LoveSpace&nbsp;!");
        $("#change1").html("Forever Love~");
    }
});
...
document.oncontextmenu = function () {
    iziToast.show({
        timeout: 2000,
        icon: "fa-solid fa-circle-exclamation",
        message: 'For browsing experience, right-click is prohibited on this site'
    });
    return false;
}
